...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-users-cog"></i> Tambah User</h1>
...
<br><div class="col-md-14">
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h10 class="font-weight-bold"><i class="fas fa-user fa-sm"> Tambah Data User</i></h10>
        </div><br>

    <div class="row">
        <div class="col-sm-12">
            <?php $errors = validation_errors()?>
        <?php echo form_open_multipart('Auth/insertData')?>
            <div class="form-row">
            ...
            <div class="form-group col-md-3">
                <label> Nama</label>
                <input class="form-control" name="nama_adm">
