...
<h10 class="h3 mb-0 text-gray-800"><i class="fas fa-map-marked-alt fa-sm" style="color: #b1b8c3;"> Edit Lokasi TPS</i></h10>
...
<div class="col-md-14">
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h6 class="font-weight-bold"><i class="fas fa-map-pin fa-sm" style="color: #888d96;"> Edit Lokasi TPS</i></h6>  
        </div>
    ...
    <div class="col-sm-5">
        <div class="row=1">
            ...
            <div class="form-group">
                ...
                <img src="<?= base_url('foto/' . $lokasi['foto_lokasi'])?>" width="50px">
            </div>
            
            
            <button  type="submit" class="btn btn-primary">
            <i class="fas fa-save fa-sm"></i> Simpan</button>
